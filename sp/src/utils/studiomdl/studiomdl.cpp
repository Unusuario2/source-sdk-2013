...
//So to track changes in the code, I will be using the 
// #ifdef STUDIOMDL_PORT_SDK2013 so we can have a clear view of the changes
// between 2006 and 2013 SDKs
...
#pragma warning( disable : 4305 )
	...
	#pragma warning( disable : 4474 ) //just for now
